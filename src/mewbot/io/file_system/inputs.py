...
class FileTypeFSInput(Input):
    ...
    def produces_inputs() -> Set[Type[InputEvent]]:
        ...
        return {
            ...
            WatchedFileWasDeletedOrMovedInputEvent,  # The monitored file is deleted
        }
    ...
    async def run(self) -> None:
        ...
        while True:
            await self._wait_for_watched_path_to_be_regular_file()
    ...
    async def _wait_for_watched_path_to_be_regular_file(self) -> None:
        """
        ...
        while True:
            ...
            # Aim is to get the event on the wire as fast as possible, to start the watcher
    ...
    async def _input_path_file_created_task(
        ...
        if await target_async_path.is_dir():
            ...
            await self.send(
                MonitoredFileWasCreatedInputEvent(file=target_async_path, base_event=None)
            )
